...
console.log("");
console.log(
  "This means that the only way for the answer to be true is if both left and right are true",
);
console.log("");
console.log(
  "The || or operator works different. Only one value has to be true",
);
console.log(`true || true is ${true || true}`);
...
console.log(
  "Numbers, string, arrays, objects and all types are generally 'truthy'",
);
console.log(
  `The values that aren't by default truthy are ${null} and ${undefined}`,
);
//@ts-ignore
...
console.log(jevon);
console.log(
  "Let's run the greet function attached to the person ${jevon.greet()}",
);
jevon.greet();
